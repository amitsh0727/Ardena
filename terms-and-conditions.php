                    ...
                    <section id="services">
                        <div class="mi-invert-fix">
                            <div class="container mil-p-0-120">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h1 class="text-center mil-muted">Terms And Conditions</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div>
                                    ...
                                    <p>By accessing or using this website, you agree to the terms outlined below. If you do not agree, please refrain from using the site.</p>
                                    <p>The content on this website is for general information purposes only.</p>
                                    <p>You agree not to use this website for any unlawful purpose or in any way that could harm its reputation.</p>
                                    <p>Unauthorized use of any content (text, graphics, logos, etc.) is prohibited.</p>
                                </div>

                                <div>
                                    <p><strong>2. Intellectual Property</strong></p>
                                    <p>All content, design, and graphics on this site are the property of Ardena unless otherwise noted. Reproduction or distribution without permission is strictly prohibited.</p>
                                </div>

                                <div>
                                    <p><strong>3. Limitations of Liability</strong></p>
                                    <p>While we strive for accuracy, Ardena is not responsible for errors, omissions, or damages resulting from the use of this site. Use is at your own risk.</p>
                                </div>

                                <div>
                                    <p><strong>4. Third-Party Links</strong></p>
                                    <p>Our website may include links to third-party websites. We are not responsible for the content, policies, or practices of these external websites.</p>
                                </div>

                                <div>
                                    <p><strong>5. Modifications to Terms</strong></p>
                                    <p>We reserve the right to update these terms at any time. Continued use of the website indicates your acceptance of any changes.</p>
                                </div>

                                <div>
                                    <p><strong>6. Contact Us</strong></p>
                                    <p>For questions about these terms, email us at: <a href="mailto:hello@ardenatech.com">hello@ardenatech.com</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
