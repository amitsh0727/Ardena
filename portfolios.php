...
<head>
    ...
    <title>Ardenatech - Portfolio</title>
    ...
    <div class="mil-wrapper" id="top">
        ...
        <div class="mil-content">
            <div id="swupMain" class="mil-main-transition">
                ...
                <div class="mil-inner-banner">
                    <div class="mil-banner-content mil-up">
                        ...
                        <div class="container">
                            ...
                            <p>In the interest of our client's privacy, we request you to connect with us to visit our complete portfolio.</p>
                            ...
                            <div class="col-lg-4">
                                <a href="https://www.instagram.com/hyattregencykathmandu" target="_blank" class="mil-portfolio-item mil-more mil-mb-60">
                                    ...
                                    <div class="mil-descr">
                                        ...
                                        <h4 class="mil-up">Hyatt Regency</h4>
                                    </div>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-4">
                                <a href="/portfolio/stem-brochure" class="mil-portfolio-item mil-more mil-mb-60">
                                    ...
                                    <div class="mil-descr">
                                        ...
                                        <h4 class="mil-up">STEM Brochure</h4>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-6">
                                <a href="/portfolio/cho-flipbook" class="mil-portfolio-item mil-more mil-mb-60">
                                    ...
                                    <div class="mil-descr">
                                        ...
                                        <h4 class="mil-up">Community Health Officers</h4>
                                    </div>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mil-portfolio-item mil-more mil-video-trigger mil-mb-60" data-video="https://www.youtube.com/watch?v=Oks5IU9Q4dA">
                                    ...
                                    <div class="mil-descr">
                                        ...
                                        <h4 class="mil-up">Lotus Botanicals</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <a href="/portfolio/pgi-dental" class="mil-portfolio-item mil-more mil-mb-60">
                                    ...
                                    <div class="mil-descr">
                                        ...
                                        <h4 class="mil-up">PGI Flipbook (Dental)</h4>
                                    </div>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mil-portfolio-item mil-more mil-video-trigger mil-mb-60" data-video="https://www.youtube.com/watch?v=Cqxx0xtjpRg">
                                    ...
                                    <div class="mil-descr">
                                        ...
                                        <h4 class="mil-up">Vehicle Scrapping Policy</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mil-portfolio-item mil-more mil-video-trigger mil-mb-60" data-video="https://www.youtube.com/watch?v=18CnPIbhqOg">
                                    ...
                                    <div class="mil-descr">
                                        ...
                                        <h4 class="mil-up">International Solar Alliance</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <!-- Video Modal -->
                <div id="video-modal" class="mil-video-modal">
                    <div class="mil-video-modal-content">
                        <button class="mil-video-close">&times;</button>
                        <div class="mil-video-container">
