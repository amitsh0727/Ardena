...
<head>
    <title>Community Health Officers - Ardenatech Portfolio</title>
    ...
    <div class="mil-wrapper" id="top">
        ...
        <div class="mil-content">
            <div id="swupMain" class="mil-main-transition">
                ...
                <!-- banner -->
                <div class="mil-inner-banner mil-banner-sm">
                    <div class="mil-banner-content mil-up">
                        ...
                        <div class="container">
                            <ul class="mil-breadcrumbs mil-mb-60">
                                ...
                                <li><a href="/portfolio/cho-flipbook">CHO Flipbook</a></li>
                            </ul>
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <span class="mil-suptitle mil-suptitle-dark mil-up mil-mb-30">Brochure Design</span>
                                    <h1 class="mil-up mil-mb-30">Community Health Officers</h1>
                                    <p class="mil-up mil-mb-30">Informational flipbook designed for Community Health Officers training program.</p>
                                </div>
                                <div class="col-lg-4">
                                    <div class="mil-adaptive-right mil-up">
                                        <div class="mil-slider-nav">
                                            <div class="mil-slider-btn-prev flipbook-prev"><i class="fas fa-arrow-left"></i></div>
                                            <div class="mil-slider-btn-next flipbook-next"><i class="fas fa-arrow-right"></i></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <!-- flipbook -->
                <section class="mil-flipbook-section">
                    <div class="mil-flipbook-slider-wrapper">
                        <div class="swiper mil-flipbook-slider">
                            <div class="swiper-wrapper">
                                <?php
                                $folder = '../img/portfolio/flipbook/flipbook-for-community-health-officers/';
                                $images = glob($folder . '*.jpg');
                                natsort($images);
                                foreach ($images as $index => $image) {
                                    $num = $index + 1;
                                    echo '<div class="swiper-slide">';
                                    echo '<div class="mil-flipbook-page">';
                                    echo '<img src="' . str_replace('../', '/', $image) . '" alt="Page ' . $num . '">';
                                    echo '<span class="mil-page-num">' . $num . '</span>';
                                    echo '</div>';
                                    echo '</div>';
                                }
                                ?>
