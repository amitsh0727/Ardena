...
<head>
    <title>Simplilearn Purdue - Ardenatech Portfolio</title>
                    ...
                    <div class="mil-banner-content mil-up">
                        ...
                        <div class="container">
                            <ul class="mil-breadcrumbs mil-mb-60">
                                ...
                                <li><a href="/portfolio/simplilearn-purdue">Simplilearn Purdue</a></li>
                            </ul>
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <span class="mil-suptitle mil-suptitle-dark mil-up mil-mb-30">Brochure Design</span>
                                    <h1 class="mil-up mil-mb-30">Simplilearn Purdue</h1>
                                    <p class="mil-up mil-mb-30">Professional brochure design for Simplilearn's Purdue University partnership program.</p>
                                </div>
                                <div class="col-lg-4">
