...
<head>
    <title>TEDx GIMS - Ardenatech Portfolio</title>
                    ...
                    <div class="mil-banner-content mil-up">
                        ...
                        <div class="container">
                            <ul class="mil-breadcrumbs mil-mb-60">
                                ...
                                <li><a href="/portfolio/tedx-gims">TEDx GIMS</a></li>
                            </ul>
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <span class="mil-suptitle mil-suptitle-dark mil-up mil-mb-30">Brochure Design</span>
                                    <h1 class="mil-up mil-mb-30">TEDx GIMS</h1>
                                    <p class="mil-up mil-mb-30">A comprehensive brochure designed for the TEDx event at GIMS, showcasing speakers, schedule, and event information.</p>
                                </div>
                                <div class="col-lg-4">
                    ...
                    <div class="mil-flipbook-slider-wrapper">
                        <div class="swiper mil-flipbook-slider">
                            <div class="swiper-wrapper">
                                <?php
                                $folder = '../img/portfolio/flipbook/tedx-gims/';
