            ...
            <div class="mil-preloader-animation">
                ...
                <div class="mil-pos-abs mil-animation-2">
                    <div class="mil-reveal-frame">
                        ...
                        <p class="mil-h3 mil-muted mil-thin">ardenatech.com</p>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <ul>
                                    <li class="mil-has-children">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="/portfolios.php">Portfolio slider</a></li>
                                        </ul>
                                    </li>
                                    <li class="mil-has-children">
                                        <a href="#.">Portfolio</a>
                                        <ul>
                                            <li><a href="/portfolios.php">Grid type 1</a></li>
                                            <li><a href="portfolio-2.html">Grid type 2</a></li>
                                            <li><a href="/portfolios.php">Slider</a></li>
                                        </ul>
                                    </li>
                                    <li class="mil-has-children">
                                        <a href="#.">Services</a>
                ...
                <section class="mil-p-120-120">
                    ...
                    <div class="container" id="project">
                        ...
                        <div class="mil-works-nav mil-up">
                            ...
                            <a href="/portfolios.php" class="mil-link mil-dark">
                ...
                <section class="mil-soft-bg">
                    <div class="container mil-p-120-120">
                        ...
                        <div class="mil-center">
                            ...
                            <div class="mil-up"><a href="/contact-us.php" class="mil-button mil-arrow-place"><span>Contact us</span></a></div>
                        </div>
                    </div>
                </section>
                <!-- call to action end -->
