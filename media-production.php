                                    ...
                                    <div class="swiper-wrapper">
                                            ...
                                            <div class="mil-portfolio-item mil-slider-item" data-swiper-parallax="-30">
                                                <div class="mil-cover-frame mil-drag">
                                                    <div class="mil-cover" data-swiper-parallax-scale="1.3">
                                                        <!-- <img src="img/works/media1.png" alt="cover"> -->
                                                        <div class="d-flex justify-content-center align-items-center " style=" width: 100%; height: 100%;">
                                                            <iframe width="100%" height="100%"
                                                                src="https://www.youtube.com/embed/Xm1DAal35gk?si=sViZrwAksWY4MaZ3"
                                                ...
                                                <div class="mil-descr" data-swiper-parallax-x="104%"
                                                    ...
                                                    <div class="mil-descr-text" data-swiper-parallax-y="100%"
                                                        ...
                                                        <div class="mil-labels mil-mb-15">
                                                            <div class="mil-label mil-upper mil-accent">Animation & Storyboarding</div>
                                                            <div class="mil-label mil-upper">may 24 2023</div>
                                                        </div>
                                                        <h5>Yellow.AI</h5>
                                                    </div>
                                                    <div data-swiper-parallax-y="120" data-swiper-parallax-opacity="0">
                                                        <a href="/contact-us.php" class="mil-button mil-arrow-place">
                                        ...
                                        <div class="swiper-slide">
                                            ...
                                            <div class="mil-portfolio-item mil-slider-item" data-swiper-parallax="-30">
                                                <div class="mil-cover-frame mil-drag">
                                                    <div class="mil-cover" data-swiper-parallax-scale="1.3">
                                                        <!-- <img src="img/works/media2.png" alt="cover"> -->
                                                        <div class="d-flex justify-content-center align-items-center " style=" width: 100%; height: 100%;">
                                                            <iframe width="100%" height="100%" src="https://www.youtube.com/embed/aU-8L7ngahw?si=cOIxDc1v8IYjVBe3" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mil-descr" data-swiper-parallax-x="104%"
                                                    ...
                                                    <div class="mil-descr-text" data-swiper-parallax-y="100%"
                                                        data-swiper-parallax-opacity="0">
                                                        <div class="mil-labels mil-mb-15">
                                                            <div class="mil-label mil-upper mil-accent">Video Production</div>
                                                            <div class="mil-label mil-upper">may 24 2023</div>
                                                        </div>
                                                        <h5>National Highways Excellence Awards 2021</h5>
                                                    </div>
                                        ...
                                        <div class="swiper-slide">
                                            ...
                                            <div class="mil-portfolio-item mil-slider-item" data-swiper-parallax="-30">
                                                <div class="mil-cover-frame mil-drag">
                                                    <div class="mil-cover" data-swiper-parallax-scale="1.3">
                                                        <!-- <img src="img/works/media3.png" alt="cover"> -->
                                                        <div class="d-flex justify-content-center align-items-center " style=" width: 100%; height: 100%;">
                                                            <iframe width="100%" height="100%" src="https://www.youtube.com/embed/Cqxx0xtjpRg?si=fqKLVBXeZ0Fnit1W" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mil-descr" data-swiper-parallax-x="104%"
                                                    ...
                                                    <div class="mil-descr-text" data-swiper-parallax-y="100%"
                                                        ...
                                                        <h5>Vehicle Scrapping Policy</h5>
                                                    </div>
                                                    <div data-swiper-parallax-y="100%" data-swiper-parallax-opacity="0">
                                                        <a href="/contact-us.php" class="mil-button mil-arrow-place">
                                                            <span>Contact Us</span>
                                        ...
                                        <div class="swiper-slide">
                                            ...
                                            <div class="mil-portfolio-item mil-slider-item" data-swiper-parallax="-30">
                                                <div class="mil-cover-frame mil-drag">
                                                    <div class="mil-cover" data-swiper-parallax-scale="1.3">
                                                        <!-- <img src="img/works/media4.png" alt="cover"> -->

                                                        <div class="d-flex justify-content-center align-items-center " style=" width: 100%; height: 100%;">
                                                            <iframe width="100%" height="100%" src="https://www.youtube.com/embed/JWJjUEGa0p8?si=ScG5r1F8FdGYduZR" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                                        </div>
                                        ...
                                        <div class="swiper-slide">
                                            ...
                                            <div class="mil-portfolio-item mil-slider-item" data-swiper-parallax="-30">
                                                <div class="mil-cover-frame mil-drag">
                                                    <div class="mil-cover" data-swiper-parallax-scale="1.3">
                                                        <!-- <img src="img/works/media5.png" alt="cover"> -->
                                                        <div class="d-flex justify-content-center align-items-center " style=" width: 100%; height: 100%;">
                                                            <iframe width="100%" height="100%" src="https://www.youtube.com/embed/j99KQ2yf2XQ?si=vTL-eL4bpvF8TGF5" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mil-descr" data-swiper-parallax-x="104%"
                                                    ...
                                                    <div class="mil-descr-text" data-swiper-parallax-y="100%"
                                                        data-swiper-parallax-opacity="0">
                                                        <div class="mil-labels mil-mb-15">
                                                            <div class="mil-label mil-upper mil-accent">Art Direction / Copywriting</div>
                                                            <div class="mil-label mil-upper">may 24 2023</div>
                                                        </div>
                                                        <h5>AVIOM SHAKTI</h5>
                                                    </div>
