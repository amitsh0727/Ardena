...
<head>
    <title>Free Marketing Assessment - Ardena</title>
    <meta name="description" content="Get a free marketing assessment from Ardena. Discover how to improve your digital presence and grow your business.">
    <?php require_once("includes/header.php") ?>
    <style>
        .mil-assessment-frame {
            background: #1a1a1a;
            border-radius: 10px;
            overflow: hidden;
        }
        .mil-assessment-frame iframe {
            display: block;
            border: none;
        }
    </style>
            ...
            <div id="swupMain" class="mil-main-transition">
                ...
                <section class="mil-dark-bg">
                    <div class="mi-invert-fix">
                        <div class="container mil-p-120-60">
                            <div class="row">
                                <div class="col-lg-10">
                                    <h1 class="mil-up mil-mb-30 mil-light">Free Marketing <span class="mil-thin">Assessment</span></h1>
                                    <p class="mil-up mil-mb-30 mil-light-soft">Discover untapped opportunities to grow your business. Our experts will analyze your current marketing efforts and provide actionable recommendations.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mi-invert-fix">
                        <div class="container mil-p-0-120">
                            <div class="row justify-content-center">
                                <div class="col-lg-10">
                                <div class="mil-assessment-frame mil-up">
                                    <iframe src="https://app.youform.com/forms/hegytzse" loading="lazy" width="100%" height="700" frameborder="0" marginheight="0" marginwidth="0"></iframe>
                                </div>
                                </div>
                            </div>
                        </div>
                ...
                <section class="mil-dark-bg">
                    <div class="mi-invert-fix">
                        <div class="container mil-p-120-60">
                            <div class="row">
                                <div class="col-lg-12 mil-center mil-mb-60">
                                    <h2 class="mil-up mil-light">What You'll <span class="mil-thin">Get</span></h2>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 mil-mb-60">
                                    <div class="mil-center mil-up">
                                        <h3 class="mil-mb-20 mil-light">01</h3>
                                        <h5 class="mil-mb-20 mil-light">Current State Analysis</h5>
                                        <p class="mil-light-soft">A comprehensive review of your existing marketing strategies and digital presence.</p>
                                    </div>
                                </div>
                                <div class="col-md-4 mil-mb-60">
                                    <div class="mil-center mil-up">
                                        <h3 class="mil-mb-20 mil-light">02</h3>
                                        <h5 class="mil-mb-20 mil-light">Opportunity Identification</h5>
                                        <p class="mil-light-soft">Key areas where you can improve and grow your business through targeted marketing.</p>
                                    </div>
                                </div>
                                <div class="col-md-4 mil-mb-60">
                                    <div class="mil-center mil-up">
                                        <h3 class="mil-mb-20 mil-light">03</h3>
                                        <h5 class="mil-mb-20 mil-light">Action Plan</h5>
                                        <p class="mil-light-soft">Clear, actionable recommendations tailored to your business goals and budget.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
